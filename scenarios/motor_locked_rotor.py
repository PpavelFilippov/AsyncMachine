"""
    Модуль scenarios/motor_locked_rotor.py.
    Состав:
    Классы: MotorLockedRotorScenario.
    Функции: нет.
"""
...
class MotorLockedRotorScenario(Scenario):
    """
        Поля:
    ...
    def describe(self) -> str:
        ...
        return (
            f"{self.name()}: ротор жёстко закреплён, t_end={self.t_end:.1f} с"
        )
