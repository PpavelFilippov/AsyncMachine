...
class MachineParameters:
    ...
    m: int = 3                  # Число фаз
    s_nom: float = 0.0127       # Номинальное скольжение

    #Параметры схемы замещения
    R1: float = 0.0279          # Активное сопротивление статора, Ом
    L1sigma: float = 0.000509   # Индуктивность рассеяния статора, Гн
    R2: float = 0.0207          # Приведённое акт. сопротивление ротора, Ом
    L2sigma: float = 0.000458   # Приведённая индуктивность рассеяния ротора, Гн
    Lm: float = 0.01668         # Индуктивность намагничивания, Гн

    #Механика
    J: float = 2.875            # Момент инерции ротора, кг·м^2

    #Кратности
    Kmm: float = 3.07           # Кратность максимального момента
    Kmp: float = 1.34           # Кратность пускового момента
    Kip: float = 6.22           # Кратность пускового тока
